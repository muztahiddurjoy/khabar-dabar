...
// $query = "SELECT food_item_id FROM orders WHERE order_id = '$order_id'";
// $order_result = mysqli_fetch_assoc(mysqli_query($conn, $query));
// echo $order_result['food_item_id'];

// Assuming you have a connection to the database in connect.php

$command = "INSERT INTO feedback (user_id, food_item_id, rating, feedback, order_id) VALUES ('$user_id', '1', '$rating', '$feedback', '$order_id')";
